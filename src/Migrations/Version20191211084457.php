 ...
 */
final class Version20191211084457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD author_id INT DEFAULT NULL, ADD episode_id_id INT DEFAULT NULL');
